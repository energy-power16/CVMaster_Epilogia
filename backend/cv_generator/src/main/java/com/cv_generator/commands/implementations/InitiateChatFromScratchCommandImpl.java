...
public class InitiateChatFromScratchCommandImpl implements BaseCommand<InitializationResponse> {
    ...
    private static final List<Message> MESSAGES_EN = Collections.singletonList(
            new Message("Welcome! Let's start creating your resume. " +
    ...
    private static final List<Message> MESSAGES_RU = Collections.singletonList(
            new Message("Добро пожаловать! Давайте начнем создание вашего резюме. " +
